...
1. is **much more efficient** running on a single GPU and allows for bigger models. This is done by using vllm to generate samples, models' alternate offloading, and some minor modifications of trl codes.
