...
1. is **much more efficient** running on a single GPU. This is done by using vllm to generate samples, models' alternate offloading, and some minor modifications of trl codes.
